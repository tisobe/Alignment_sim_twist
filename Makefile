...
BIN  = alignment_sim_twist_extract.perl alignment_sim_twist_extract_acadata.perl alignment_sim_twist_fid_trend_plots.perl alignment_sim_twist_remove_dupl.perl alignment_sim_twist_wrap_script alignment_sim_twist_main_script
DOC  = README

...
#	print OUT "version=last\n";
	...
	system("cd ./Sim_twist_temp/; echo $hakama  |/home/ascds/DS.release/bin/arc4gl -U$dare -Sarcocc -i./input_line"); # here is the arc4gl
#
...
#	system("perl /home/ascds/DS.release/bin/dataseeker.pl outfile=./Sim_twist_temp/out.fits search_crit=\"columns=_fapos_avg,_tscpos_avg timestart=$tstart_sec timestop=$tstop_sec\"");
	...
	close(FH);
	system("rm ./Sim_twist_temp/out.fits");
	...
	close(FH);
	system("rm ./Sim_twist_temp/pcadf*fits");
}
...
#
		...
		close(IN);
		system('rm ./Sim_twist_temp/zout2');
		system('rm ./Sim_twist_temp/tmp.fits');
